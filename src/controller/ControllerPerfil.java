...
public class ControllerPerfil implements Initializable {
    ...
    @FXML
    private Button btnVoltarTelaPlayer;
    
    @FXML
    private Button btnDeslogarDaConta;
    ...
    @FXML
    private void VoltarTelaParaPlayer (ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("/telas/Player.fxml"));
        Scene scene = new Scene(root);
        main.Main.myStage.setScene(scene);   
    }
    private void DeslogarConta (ActionEvent event) throws IOException {
